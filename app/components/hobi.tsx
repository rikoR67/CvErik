...
import hobby1 from '../gamer.jpg';
import hobby2 from '../gitar.jpg';
import hobby3 from '../Riding.jpg';
import hobby4 from '../melukis.jpg';

const HobbiesGallery: React.FC = () => {
  const hobbies = [
    { id: 1, title: 'Gamer', image: hobby1 },
    { id: 2, title: 'Bermain Musik', image: hobby2 },
    { id: 3, title: 'Riding', image: hobby3 },
    { id: 4, title: 'Melukis', image: hobby4 },
  ];
  ...
  return (
    <div style={styles.container}>
      <h2 style={styles.title}>My Gallery Tentang Hobby</h2>
